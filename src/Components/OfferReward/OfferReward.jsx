...
// const OfferCard = ({ title, description, buttonText, image }) => (
...
//       <button className="bg-white text-green-700 font-medium py-2 px-6 rounded-md w-fit hover:bg-gray-100 transition duration-300">
//         {buttonText}
//       </button>
//     </div>
...
// const SideOfferCard = ({ title, description, buttonText, image }) => (
...
//         <button className="bg-white text-green-700 font-medium py-1 px-4 rounded-md w-fit text-sm sm:text-base hover:bg-gray-100 transition duration-300">
//           {buttonText}
//         </button>
//       </div>
//       <div className="w-full sm:w-1/2">
...
//       <h1 className="text-2xl sm:text-3xl font-bold mb-6">Offers & Rewards</h1>
...
const SideOfferCard = ({ title, description, buttonText, image, link }) => (
  <div className="bg-[#4A664A] rounded-lg overflow-hidden mb-6 h-[192px] sm:h-[192px]">
    <div className="flex h-full">
      <div className="w-full sm:w-1/2 p-4 text-white flex flex-col justify-center">
        <h3 className="text-xl sm:text-2xl font-bold mb-2">{title}</h3>
...
const OfferReward = () => {
  const offers = [
    {
      ...
      buttonText: 'Buy It Now',
      image: plant11,
      link: '/filter?offer=living-gift', // Example filter link
    },
    {
      title: 'Deal of the week',
      description: 'Express true emotions with a gift that grow faster',
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-2xl md:text-3xl font-bold mb-6 text-center">Offers & Rewards</h1>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="sm:col-span-2">
          {offers.map((offer, index) => (
            <OfferCard key={index} {...offer} />
