...
const FaqAccordion = () => {
  ...
  return (
    <div className="container mx-auto p-4"> {/* Wrap everything in a single div */}
      <h2 className="text-2xl font-bold mb-4">FAQ'S</h2> {/* Heading for the FAQ section */}
      <div className="border border-gray-500 rounded-lg"> {/* Added border here */}
        {faqItems.map((item, index) => (
          <div key={index} className="border-b last:border-b-0"> {/* Removed bottom border for the last item */}
            <button
              className="w-full text-left p-4 flex justify-between items-center bg-white hover:bg-gray-200 focus:outline-none"
