...
//   return (
//     <div className="w-64 p-16  bg-white mt-8">
//       <div className="mb-6 flex justify-between items-center">
//         <h2 className="text-base font-normal text-gray-900">Filter</h2>
//         <button className="px-2 py-1 text-xs bg-gray-200 rounded text-gray-700">
//           RESET
//         </button>
//       </div>
...
const FilterSidebar = () => {
  ...
  return (
    <div className="w-full p-12 h-auto bg-white mt-8">
      <div className="mb-6 flex justify-between items-center">
